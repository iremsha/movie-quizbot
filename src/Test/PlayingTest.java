...
public class PlayingTest {
    ...
    public void canPlay() throws IOException {
        ...
        assertEquals(UserAction.play, bot.sessions.get(0).getAction());
    }
    ...
    public void canStop() throws IOException {
        ...
        assertNull(bot.sessions.get(0).getAction());
    }
    ...
    public void increaseScoreIfRightAnswer() throws IOException {
        var scoreBefore = bot.sessions.get(0).getUser().getScore();
        bot.processInput("/play", 0);
        bot.processInput("answer", 0);
        var scoreAfter = bot.sessions.get(0).getUser().getScore();
